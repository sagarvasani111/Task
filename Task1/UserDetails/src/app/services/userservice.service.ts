...
export class UserserviceService {
  ...
  getSearchData(pageNo: number, pageSize: number, sortOrder: string,searchTerm:any){
    return this.http.get(this.url + '/GetUserBySearch?pageNo=' + pageNo + '&pageSize=' + pageSize + '&sortOrder=' + sortOrder + '&name=' + searchTerm)
  }
